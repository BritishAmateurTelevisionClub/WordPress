$(document).ready(function () {
    ...
    $('input[type="checkbox"]').click(function () {
        ...
        if ($(this).is(":checked")) {
            ...
            //----------------------
            if (inputValue == 'sign') {
                $('#wf_signature_text_main').show();
                $('#company_sign_image').show();
            ...
            if (inputValue == 'order_number')
            {
                $('#wf_order_number').show();
            ...
            //---------------------------
            if (inputValue == 'sign') {
                $('#wf_signature_text_main').hide();
                $('#company_sign_image').hide();
            }
            //----------------------------
            if (inputValue == 'invoice_number')
            {
    ...
    //-------------------------------signature image #collapse142
    //height change for image
    jQuery("#collapse142").on('keyup', '#wf_sign_img_height', function (e) {
        var text_height_value = $("#wf_sign_img_height").val();
        if ($.isNumeric(text_height_value))
        {
            jQuery('#company_sign_image').prop("height", text_height_value);
        }
    });
    //width change for image
    jQuery("#collapse142").on('keyup', '#wf_sign_img_width', function (e) {
        var text_width_value = $("#wf_sign_img_width").val();
        if ($.isNumeric(text_width_value))
        {
            jQuery('#company_sign_image').prop("width", text_width_value);
        }
    });

    //font size change
    jQuery("#collapse142").on('keyup', '#sign_font', function (e) {
        var text_width_value = $("#sign_font").val();
        if ($.isNumeric(text_width_value))
        {
            var text_value = $("#sign_text").val();
            var text_width_value = $("#sign_font").val();
            jQuery('#wf_font_size_for_signature').text(text_value);
            jQuery('#wf_font_size_for_signature').css('font-size', text_width_value + 'px');
        }
    });

    //Invoice text change
    jQuery("#collapse142").on('keyup', '#sign_text', function (e) {
        var text_value = $("#sign_text").val();
        var text_width_value = $("#sign_font").val();
        jQuery('#wf_font_size_for_signature').text(text_value);
        jQuery('#wf_font_size_for_signature').css('font-size', text_width_value + 'px');
    ...
    jQuery("#collapse142").on('change', '#wf_sign_text_align', function (e) {
        var text_align_value = $("#wf_sign_text_align").val();
        jQuery('#wf_font_size_for_signature').css('text-align', text_align_value);
        jQuery('#company_sign_image').css('float', text_align_value);
    });
    ...
    jQuery("#collapseThree1").on('change', '#wf_invoice_number_font_weight', function (e) {
        ...
        jQuery('#wf_invoice_name').css('font-weight', text_width_value);
        jQuery('#wf_invoice_label').css('font-weight', text_width_value);
        jQuery('#wf_packing_slip_name').css('font-weight', text_width_value);
        jQuery('#wf_packing_slip_label').css('font-weight', text_width_value);
         jQuery('#wf_delivery_note_name').css('font-weight', text_width_value);
        jQuery('#wf_delivery_note_label').css('font-weight', text_width_value);
    });
    ...
    jQuery("#collapseThree1").on('keyup', '#wf_invoice_font', function (e) {
        ...
        if ($.isNumeric(text_width_value))
        {
            ...
            jQuery('#wf_packing_slip_name').css('font-size', text_width_value + 'px');
            jQuery('#wf_delivery_note_name').css('font-size', text_width_value + 'px');
        }
    });
    ...
    jQuery("#collapseThree1").on('change', '#wf_invoice_number_color_code', function (e) {
        ...
        jQuery('#wf_packing_slip_name').css("color", '#' + text_color_value, 'important');
        jQuery('#wf_delivery_note_name').css("color", '#' + text_color_value, 'important');
    ...
    jQuery("#collapseEighty9").on('change', '#wf_order_number_font_weight', function (e) {
        var text_width_value = $("#wf_order_number_font_weight").val();
        jQuery('#wf_order_number').css('font-weight', text_width_value);
        jQuery('#wf_order_number_label').css('font-weight', text_width_value);

    });

    //font size change invoice number
    jQuery("#collapseEighty9").on('keyup', '#wf_order_number_font', function (e) {
        var text_width_value = $("#wf_order_number_font").val();
        if ($.isNumeric(text_width_value))
        {
            jQuery('#wf_order_number').css('font-size', text_width_value + 'px');
        }
    });

    //Invoice text change
    jQuery("#collapseEighty9").on('keyup', '#wf_order_number_text', function (e) {
        var text_width_value = $("#wf_order_number_text").val();
        jQuery('#wf_order_number_label').text(text_width_value);
    });



    //height change body color
    jQuery("#collapseEighty9").on('change', '#wf_order_number_color_code', function (e) {
        var text_color_value = $("#wf_order_number_color_code").val();

        jQuery('#wf_order_number').css("color", '#' + text_color_value, 'important');
        $("#wf_order_number_color_code_default").attr("checked", false);
    });
...
//font size change invoice number
    jQuery("#collapseFour1").on('keyup', '#wf_invoice_date_font', function (e) {
        ...
        if ($.isNumeric(text_width_value))
        {
            ...
            jQuery('#wf_packing_slip_date').css('font-size', text_width_value + 'px');
            jQuery('#wf_delivery_note_date').css('font-size', text_width_value + 'px');
...
//Invoice text change
    jQuery("#collapseFour1").on('keyup', '#wf_invoice_date_text', function (e) {
        ...
        jQuery('#wf_delivery_note_date_label').text(text_width_value);
    });
    ...
    jQuery('#wf_invoice_date').css('font-weight', text_width_value);
    jQuery('#wf_invoice_main_date').css('font-weight', text_width_value);
        jQuery('#wf_invoice_date_label').css('font-weight', text_width_value);
        jQuery('#wf_packing_slip_date').css('font-weight', text_width_value);
        jQuery('#wf_packing_slip_date_label').css('font-weight', text_width_value);
        
        jQuery('#wf_packing_slip_main_date').css('font-weight', text_width_value);
        jQuery('#wf_delivery_note_date').css('font-weight', text_width_value);
        jQuery('#wf_delivery_note_date_label').css('font-weight', text_width_value);
        
        jQuery('#wf_delivery_note_main_date').css('font-weight', text_width_value);
    });
    ...
    jQuery("#collapseFour1").on('change', '#wf_invoice_date_color', function (e) {
        ...
        jQuery('#wf_packing_slip_date').css("color", '#' + text_color_value, 'important');
         jQuery('#wf_delivery_note_date').css("color", '#' + text_color_value, 'important');
...
//Invoice text change
    ...
    jQuery("#collapse41").on('change', '#wf_order_date_font_weight', function (e) {
        ...
        jQuery('#wf_order_date').css('font-weight', text_width_value);
        jQuery('#wf_order_date_label').css('font-weight', text_width_value);
        jQuery('#wf_order_main_date').css('font-weight', text_width_value);
    });
...
//Produt table
    ...
    jQuery("#collapse151").on('keyup', '#wf_fee_text', function (e) {
        var text_width_value = $("#wf_fee_text").val();
        jQuery('#wf_id_for_fee').text(text_width_value);
    });
    ...
    jQuery("#collapse200").on('keyup', '#return_address_title', function (e) {
        var text_width_value = $("#return_address_title").val();
        jQuery('#returntitle').text(text_width_value);
    });


    jQuery("#collapse200").on('change', '#return_title_align', function (e) {
        var text_width_value = $("#return_title_align").val();
        jQuery('#returnAddress').css('text-align', text_width_value);
    });
