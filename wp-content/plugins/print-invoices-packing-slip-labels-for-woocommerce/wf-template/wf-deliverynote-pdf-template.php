...
$main_data = '';
if(($acive_template === 'wf_delivery_note_template_1') || ($invoice_from != ''  && $invoice_from === 'wf_delivery_note_template_1' ))
{
  $main_data = get_option('wf_packing_slip_template_1pdf');
}

if(( $acive_template === 'wf_delivery_note_template_2') || ($invoice_from !='' && $invoice_from === 'wf_delivery_note_template_2') )
{
	$main_data = get_option('wf_packing_slip_template_2pdf');
}
if(( $acive_template === 'wf_delivery_note_template_3') || ($invoice_from !='' && $invoice_from === 'wf_delivery_note_template_3') )
{
...
if(in_array('email', $this->deliverynote_contactno_email)) {
...
if(in_array('contact_number', $this->deliverynote_contactno_email)) {
...
if ($this->wf_packinglist_get_return_policy() != '') { 
	$main_data 		= str_replace('[invoice return policy data]', $this->wf_packinglist_get_return_policy() , $main_data);
