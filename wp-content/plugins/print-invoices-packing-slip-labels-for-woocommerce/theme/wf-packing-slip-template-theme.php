  ...
  <header>
    ...
    <img style='[company logo visible]' class='logo' src='[image url for company logo]' alt='' id='company_logo_image' height='[logo height]' width='[logo width]' />
      ...
      <div id='wf_extra_data_below_logo' style='[wf extra filed show hide][invoice extra field font size]'> [Extra data below logo] </div>
        ...
        <div style='[invoice font weight][invoice number switch][invoice number prob][invoice_number_color]' id='wf_packing_slip_name'>
          <label id='wf_packing_slip_label' style='[invoice font weight]'>[invoice name]</label> [invoice number]
        </div>
     

      <div style='[invoice date font size][invoice date label font weight][invoice date color code][invoice date show hide]' id='wf_packing_slip_date'> <label id='wf_packing_slip_date_label' style='[invoice date label font weight]' > [invoice Date label text] </label> <label  id='wf_packing_slip_main_date'  style='[invoice date label font weight]' >[invoice created date]</label> 
      </div>
  ...
  <div>
    <div class='article' >
      <header style='height: 200px;'>
        ...
        <p style='padding:unset;margin:unset;line-height:unset;[wf email show hide]' id='wf_font_size_for_email'><font id='wf_email_text_main'><strong>[email label]</strong></font> [email address]</p>
      ...
      <table class='tableclass' style='width: 100%; border-collapse: collapse;border-bottom-width: thin; border-top-width: thin;' cellspacing='0' cellpadding='0' class='new_table_border' colspan='[table colum span]'>
        <thead style='display:table-header-group;[wf product table head color][wf product table head text color]' class='new_table_value' id='wf_product_head'>
          ...
          <th scope='col' id='th_img' class='new_table_border' style='[table colum img hide]background:unset;color:unset;text-align:unset; border-top-width: thin; padding: 5px;'>
           ...
           <th scope='col' id='th_sku' class='new_table_border' style='[table colum span hide]background:unset;color:[wf product table text color main];text-align:unset; border-top-width: thin; padding: 5px;'>[sku label text]
           
          </th>

          <th scope='col' class='new_table_border' colspan='[table colum span]' id='th_product' style='background:unset;color:[wf product table text color main];text-align:unset; border-top-width: thin; padding: 5px;'>[product label text]
          </th>
          <th scope='col' class='new_table_border' id='th_qty' style='background:unset;color:[wf product table text color main];text-align:unset;  border-top-width: thin; padding: 5px;'>[table quantity text]
          </th>
          <th scope='col' class='new_table_border' id='th_total_weight' style='[pk weight show hide] ;background:unset;color:[wf product table text color main];text-align:unset; border-top-width: thin; padding: 5px;'>[table total weight price text]
          </th>
          <th scope='col' class='new_table_border' id='th_total' style='[pk price show hide]background:unset;color:[wf product table text color main];text-align:unset; border-top-width: thin; padding: 5px;'>[table toatl price text]
          </th>
        </tr>
      </thead>
     ...
     <div class='container'>
      <div class='details clearfix'>
        <div class='client left'>
          <p class='name' id='wf_packing_slip_name' style='[invoice number switch][invoice font weight][invoice number prob][invoice_number_color]'><label id='wf_packing_slip_label' style='[invoice font weight]'>[invoice name]</label> [invoice number]</p>
        </div>
        <div class='data right'>
          <p class='name' id='wf_packing_slip_date' style='[invoice date label font weight][invoice date font size][invoice date color code][invoice date show hide]'><label id='wf_packing_slip_date_label' style='[invoice date label font weight]' > [invoice Date label text] </label> <label style='[invoice date label font weight]' id='wf_packing_slip_main_date' >[invoice created date]</label></p>
        </div>
        <div class='data right'>
          <p class='name' id='wf_order_date' style='[order date label font weight][order date font size][order date color code][order date show hide]'><label id='wf_order_date_label' style='[order date label font weight]' > [order date label]</label> <label style='font-weight:[order date label font weight]' id='wf_order_main_date' >[order date]</label></p>
        </div>
      </div>
    </div>
</section>
      ...
      <table border='0' cellspacing='0' cellpadding='0' style='page-break-inside:auto' colspan='[table colum span]'>
        <thead style='display:table-header-group;[wf product table head color][wf product table head text color]' id='wf_product_head' class='default-table-data'>
          <tr style='page-break-inside:avoid; page-break-after:auto;[wf product table text align]' id='wf_head_tr_align_purpose'>
            <th class='qty' id='th_img' style='[table colum img hide]text-align:unset;background:unset;color:[wf product table text color main];'>[img label text]</th>
            <th class='desc' id='th_sku' style='[table colum span hide];text-align:unset;background:unset;color:[wf product table text color main];'>[sku label text]</th>
            <th class='desc' colspan='[table colum span]' style='width: 59%;text-align:unset;background:unset;color:[wf product table text color main];' id='th_product'>[product label text]</th>
            <th class='unit' id='th_qty' style='text-align:unset;background:unset;color:[wf product table text color main];'>[table quantity text]</th>
            <th class='unit' id='th_total_weight' style='[pk weight show hide]text-align:unset;background:unset;color:[wf product table text color main];'>[table total weight price text]</th>
            <th class='total' id='th_total' style='[pk price show hide]text-align:unset;background:unset;color:[wf product table text color main];'>[table toatl price text]</th>
          </tr>
        </thead>
...
if(get_option('wf_developer_tool_for_change_data_in_pk') && get_option('wf_developer_tool_for_change_data_in_pk') != $developer_value )
{
  update_option('wf_packing_slip_template_3'," <link href='[wf link]assets/new_invoice_css_js/dist/css/bootstrap.css' rel='stylesheet'>
  <link href='[wf link]assets/new_invoice_css_js/font-awesome/css/font-awesome.css' rel='stylesheet'>
  <link href='[wf link]assets/new_invoice_css_js/css/custom.min.css' rel='stylesheet'>
  <style>
#wpfooter
{
  ...
  <div class='row'>
    ...
    <img style='[company logo visible]' class='logo' src='[image url for company logo]' alt='' id='company_logo_image' height='[logo height]' width='[logo width]' />
        ...
        <small class='pull-right' style='text-align:right;[invoice font weight];' >
        <font id='wf_packing_slip_name' style='[invoice font weight][invoice number switch][invoice number prob][invoice_number_color]'>
        <label style='[invoice font weight]' id='wf_packing_slip_label'>[invoice name]</label> [invoice number] <br> </font>

        <p style='[invoice date font size];text-align:right;'> 
        <font id='wf_packing_slip_date' style='[invoice date label font weight][invoice date font size][invoice date color code][invoice date show hide]'> 
        <label id='wf_packing_slip_date_label' style='[invoice date label font weight]' >[invoice Date label text] </label>
         <label style='[invoice date label font weight]' id='wf_packing_slip_main_date' >[invoice created date]</label> <br></font>

         <font id='wf_order_date' style='[order date font size][order date label font weight][order date color code][order date show hide]'> <label id='wf_order_date_label' style='[order date label font weight]' > [order date label]</label> <label style='[order date label font weight]' id='wf_order_main_date' >[order date]</label></font></p></small>
      </h1>
      <div id='wf_extra_data_below_logo' style='[wf extra filed show hide][invoice extra field font size]'> [Extra data below logo] </div>
    </div>
      ...
      <table class='table table-striped' style='page-break-inside:auto' colspan='[table colum span]'>
        <thead style='display:table-header-group;[wf product table head color][wf product table head text color]' id='wf_product_head'>
          <tr style='page-break-inside:avoid; page-break-after:auto;[wf product table text align]' id='wf_head_tr_align_purpose'>
            ...
            <th id='th_qty' style='text-align:unset;color:[wf product table text color main];'>[table quantity text]</th>
            <th id='th_total_weight' style='[pk weight show hide]text-align:unset;color:[wf product table text color main];'>[table total weight price text]</th>
            <th id='th_total' style='[pk price show hide]text-align:unset;color:[wf product table text color main];'>[table toatl price text]</th>
          </tr>
        </thead>
        <tbody style='[wf product table text color main][wf product table body text align]' id='wf_product_body' >
          [table tbody content value] 
...
$installed_language = get_option('WF_PK_LANG');

if( (get_option('wf_developer_tool_for_change_data_in_pk') && get_option('wf_developer_tool_for_change_data_in_pk') != $developer_value) || (empty($installed_language) || $default_language != $installed_language) )
{
  update_option('wf_packing_slip_active_value',"auto|60|yes|logo|yes|21|bold|Order:|default|no|d-m-Y|21|".$this->invoice_labels['order_date'].":|normal|default|yes|d-m-Y|21|Date:|normal|default|yes|From Address :|left|default|yes|".$this->invoice_labels['billing_address'].":|left|default|yes|".$this->invoice_labels['shipping_address'].":|left|default|yes|14|Email:|left|default|yes|14|Tel:|left|default|yes|14|VAT:|left|default|yes|14|SSN:|left|default|yes|14|".$this->invoice_labels['tracking_provider'].":|left|default|yes|14|".$this->invoice_labels['tracking_number'].":|left|default|yes|default|default|center|default|center|".$this->invoice_labels['sku']."|".$this->invoice_labels['product_name']."|".$this->invoice_labels['quantity']."|".$this->invoice_labels['total_price']."|Image|Total Weight|none|14");
   update_option('WF_PK_LANG',$default_language);
}
if(get_option('wf_developer_tool_for_change_data_in_pk') && get_option('wf_developer_tool_for_change_data_in_pk') != $developer_value )
{
  for ($i=1; get_option('wf_packing_slip_template_'.$i) !='' ;$i++)
  {
    if(get_option('wf_packing_slip_template_'.$i.'from'))
    {
      $data_chenge = get_option('wf_packing_slip_template_'.$i.'from');
      update_option('wf_packing_slip_template_'.$i,get_option($data_chenge));
    }
  }
