<?php 
ob_start();
$developer_value = 'wf_pk_dev_key_check_1';
$check_data = get_option('wf_developer_tool_for_change_data_in_pk_pdf') ===false ? update_option('wf_developer_tool_for_change_data_in_pk_pdf','print_invoice') : 'yes'; 
if(get_option('wf_developer_tool_for_change_data_in_pk_pdf') && get_option('wf_developer_tool_for_change_data_in_pk_pdf') != $developer_value )
{
  update_option('wf_packing_slip_template_1pdf', "
<html>
<head>
...
if(get_option('wf_developer_tool_for_change_data_in_pk_pdf') && get_option('wf_developer_tool_for_change_data_in_pk_pdf') != $developer_value )
{
update_option('wf_packing_slip_template_2pdf',"
   <html>      <head>
    <meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
     ...
     <div class='container'>
      <div class='details clearfix'>
        ...
        <div class='data right'>
          <p class='name' id='wf_packing_slip_date' style='[invoice date font size][invoice date color code][invoice date show hide]'><label id='wf_packing_slip_date_label' style='[invoice date label font weight]' > [invoice Date label text] </label> <label style='[invoice date label font weight]' id='wf_packing_slip_main_date' >[invoice created date]</label></p>
        </div>
        <div class='data right'>
...
if(get_option('wf_developer_tool_for_change_data_in_pk_pdf') && get_option('wf_developer_tool_for_change_data_in_pk_pdf') != $developer_value )
{
  update_option('wf_packing_slip_template_3pdf',"
...
<body style='width:85%;height:100%;border: 3px solid lightgrey;padding:10px;>
  ...
  <div class='row'>
    ...
    <img style='[company logo visible]' class='logo' src='[image url for company logo]' alt='' id='company_logo_image' height='[logo height]' width='[logo width]' />
        ...
        <small class='pull-right' style='text-align:right;' ><font id='wf_packing_slip_name' style='[invoice number switch][invoice number prob][invoice_number_color]'><label style='[invoice font weight]' id='wf_packing_slip_label'>[invoice name]</label> [invoice number] <br> </font><p style='text-align:right;font-size: 20px;'> <font id='wf_packing_slip_date' style='[invoice date font size][invoice date color code][invoice date show hide]'> <label id='wf_packing_slip_date_label' style='[invoice date label font weight]' > [invoice Date label text] </label> <label style='font-weight:normal' id='wf_packing_slip_main_date' >[invoice created date]</label> <br></font><font id='wf_order_date' style='[order date font size][order date color code][order date show hide]'> <label id='wf_order_date_label' style='[order date label font weight]' > [order date label]</label> <label style='font-weight:normal' id='wf_order_main_date' >[order date]</label></font></p></small>
      </h1>
      <div id='wf_extra_data_below_logo' style='[wf extra filed show hide][invoice extra field font size]'> [Extra data below logo] </div>
    </div>
