	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<textarea name="ihc_list_access_posts_custom_css" style="width: 100%; height: 150px;"><?php echo stripslashes($data['metas']['ihc_list_access_posts_custom_css']);?></textarea>
			</div>
