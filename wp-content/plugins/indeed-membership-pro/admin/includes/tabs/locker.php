		...
		?>
			<form method="post" action="<?php echo $url.'&tab='.$tab.'&subtab=lockers_list';?>">
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						<textarea id="ihc_locker_custom_css" name="ihc_locker_custom_css" onBlur="ihc_locker_preview();" class="ihc-dashboard-textarea-full"><?php echo stripslashes($meta_arr['ihc_locker_custom_css']);?></textarea>
