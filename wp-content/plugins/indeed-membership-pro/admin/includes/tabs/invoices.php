	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<textarea name="ihc_invoices_custom_css" onblur="iump_admin_preview_invoice();" style="width: 100%; height: 150px;"><?php echo stripslashes($data['metas']['ihc_invoices_custom_css']);?></textarea>
			</div>
