		...
		$settings = array_merge(
			array(
				...
				array(
					...
					'desc'      => __( 'Next new order will be given this number.', 'custom-order-numbers-for-woocommerce' ) . ' ' .
						sprintf( __( 'Use <a class="button-primary" id="alg-tool-button" href="%s">Renumerate Orders tool</a> for existing orders.', 'custom-order-numbers-for-woocommerce' ),
							admin_url( 'admin.php?page=alg-wc-renumerate-orders-tools' ) ),
				...
				array(
					...
					'desc'      => apply_filters( 'alg_wc_custom_order_numbers', sprintf( 'You will need <a href="%s" target="_blank">Custom Order Numbers for WooCommerce Pro</a> plugin to set this option.', 'https://wpfactory.com/item/custom-order-numbers-woocommerce/' ), 'settings' ),
				...
				array(
					...
					'desc_tip'  => __( 'This will add "Order Number" meta box to each order\'s edit page. "Order Numbers Counter" must be set to "Sequential".', 'custom-order-numbers-for-woocommerce' ) . '<br>' .
						apply_filters( 'alg_wc_custom_order_numbers', sprintf( 'You will need <a href="%s" target="_blank">Custom Order Numbers for WooCommerce Pro</a> plugin to set this option.', 'https://wpfactory.com/item/custom-order-numbers-woocommerce/' ), 'settings' ),
