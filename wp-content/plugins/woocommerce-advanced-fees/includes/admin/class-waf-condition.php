...
class WAF_Condition {
	...
	public function get_conditions() {
		return waf_get_available_conditions();
	}
	...
	public function get_operators() {
		...
		return apply_filters( 'woocommerce_advanced_fees_operators', $wpc_condition->get_available_operators(), $wpc_condition );
	}
	...
	public function get_value_field_args() {
		...
		if ( $this->condition == 'contains_product' && $product = wc_get_product( $this->value ) ) {
			$field_args['custom_attributes']['data-selected'] = $product->get_formatted_name(); // WC < 3.0
			$field_args['options'][ $this->value ] = $product->get_formatted_name(); // WC >= 3.0
		}

		$field_args = apply_filters( 'woocommerce_advanced_fees_values', $field_args, $this->condition );
	...
	public function get_description() {
		$descriptions = wpc_condition_descriptions();
