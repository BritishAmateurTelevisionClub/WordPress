...
global $post;
$condition_groups = get_post_meta( $post->ID, 'conditions', true );

?><div class='wpc-conditions wpc-conditions-meta-box'>
	<div class='wpc-condition-groups'>

		<p>
			<strong><?php _e( 'Match one of the condition groups to apply the fee', 'woocommerce-advanced-fees' ); ?></strong>
		</p><?php
	...
	<div class='wpc-condition-group-template hidden' style='display: none'><?php
		...
		include 'html-condition-group.php';
	?></div>
	<a class='button wpc-condition-group-add' href='javascript:void(0);'><?php _e( 'Add \'Or\' group', 'woocommerce-advanced-fees' ); ?></a>
</div>