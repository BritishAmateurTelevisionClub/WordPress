 ...
 * @version    $Id: Text.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
...
class SetaPDF_Stamper_Stamp_Text extends SetaPDF_Stamper_Stamp
{
     ...
     * The constructor.
     * 
     * @param SetaPDF_Core_Font $font The font type of the text
     ...
     *
     * @param SetaPDF_Core_Font $font The new font type
     ...
     * @param SetaPDF_Core_DataStructure_Color|SetaPDF_Core_Type_Array|array|number $color The new text color
     */
     ...
     * @see SetaPDF_Core_DataStructure_Color::createByComponents()
     * @param SetaPDF_Core_DataStructure_Color|SetaPDF_Core_Type_Array|array|number $color The new outline color
     */
     ...
     *
     * @see SetaPDF_Core_DataStructure_Color::createByComponents()
     * @param SetaPDF_Core_DataStructure_Color|SetaPDF_Core_Type_Array|array|number|null $color The new background color
     */
     ...
     *
     * @see SetaPDF_Core_DataStructure_Color::createByComponents()
     * @param SetaPDF_Core_DataStructure_Color|SetaPDF_Core_Type_Array|array|number|null $color The new border color
     */
