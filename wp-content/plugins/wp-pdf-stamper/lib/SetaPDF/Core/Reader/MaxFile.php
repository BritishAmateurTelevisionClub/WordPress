 ...
 * @version    $Id: File.php 759 2015-10-18 18:50:31Z jan.slabon $
 */
...
class SetaPDF_Core_Reader_MaxFile extends SetaPDF_Core_Reader_File
{
     ...
     * @param SetaPDF_Core_Reader_MaxFileHandler $handler The handler to which this instance should be bound and notify
     *                                                    when opening closing file handles.
     * @throws Exception
     */
    public function __construct($filename, SetaPDF_Core_Reader_MaxFileHandler $handler)
    {
    ...
    {
        $this->wakeUp();
        return parent::increaseLength($length);
    }
