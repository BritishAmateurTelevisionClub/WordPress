 ...
 * @version    $Id: Encoding.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
...
class SetaPDF_Core_Encoding
{
  /* PDF specific predefined encodings */
    ...
    {
        if ('mb' === self::getLibrary()) {
            $t = unpack('N', mb_convert_encoding($utf16, 'UTF-32BE', 'UTF-16BE'));
        } else {
            $t = unpack('N', iconv('UTF-16BE', 'UTF-32BE', $utf16));
        }
