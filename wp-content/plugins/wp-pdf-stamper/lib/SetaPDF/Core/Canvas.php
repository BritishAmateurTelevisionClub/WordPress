 ...
 * @version    $Id: Canvas.php 840 2016-05-09 12:53:34Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Canvas_StreamProxyInterface
{
  ...
  /** Setting Colors **/
     ...
     * Set the color.
     *
     * @param SetaPDF_Core_DataStructure_Color|array|int|string $color The color
     ...
     *
     * @param SetaPDF_Core_DataStructure_Color|array|int|string $color The stroking color
     * @return $this
     */
     ...
     *
     * @param SetaPDF_Core_DataStructure_Color|array|int|string $color The non-stroking color
     * @return $this
     */
