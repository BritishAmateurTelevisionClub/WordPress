 ...
 * @version    $Id: Type3.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Font_Glyph_Collection_CollectionInterface
{
    ...
    public function getFontBBox()
    {
        if (null === $this->_fontBBox) {
            ...
            $fontBBox = $fontBBox->ensure()->toPhp();
            /* At the end it is sometimes neither possible to get the height without rendering
               the glyps at all. The d0 and d1 operators will not offer a height all the time...
            if (array_sum($fontBBox) == 0) {
                ...
                $avarageWidth = array_sum($widths) / count($widths);
                // Quick fix.
                $fontBBox[0] = 0;
                $fontBBox[1] = 0;
                $fontBBox[2] = $avarageWidth;
                $fontBBox[3] = $avarageWidth * 1.5;
            }
            */
