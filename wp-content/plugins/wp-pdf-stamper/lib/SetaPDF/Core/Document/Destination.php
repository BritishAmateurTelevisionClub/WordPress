 ...
 * @version    $Id: Destination.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Destination
{
     ...
     */
    static public function createDestinationArray(
        SetaPDF_Core_Type_IndirectObject $pageObject,
        $fitMode = self::FIT_MODE_FIT
    )
    {
