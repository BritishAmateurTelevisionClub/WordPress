 ...
 * @version    $Id: OptionalContent.php 840 2016-05-09 12:53:34Z jan.slabon $
 */
...
class SetaPDF_Core_Document_Catalog_OptionalContent implements IteratorAggregate
{
    ...
    )
    {
        ...
        if ($parent instanceof SetaPDF_Core_Document_OptionalContent_Group) {
            $objectIdent = $parent->getIndirectObject($this->getDocument())->getObjectIdent();
            $searchByObject = true;
        }
