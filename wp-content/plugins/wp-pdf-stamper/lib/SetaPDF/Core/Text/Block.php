 ...
 * @version    $Id: Block.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
...
class SetaPDF_Core_Text_Block
{
    ...
    public function setText($text, $encoding = 'UTF-8')
    {
        ...
        $this->_internalText = SetaPDF_Core_Encoding::convert($text, $encoding, 'UTF-16BE');
    }
    ...
    public function getLineHeight()
    {
        if (null === $this->_lineHeight) {
            ...
            return $this->getFontSize() * ($fontBBox['ury'] - $fontBBox['lly']) / 1000;
        }
    ...
    protected function _fixY($y)
    {
        ...
        $fontBBox = $this->_font->getFontBBox();
        $ury = $this->getFontSize() * $fontBBox['ury'] / 1000;
        $lly = $this->getFontSize() * $fontBBox['lly'] / 1000;
