 ...
 * @version    $Id: WinAnsi.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
    ...
    implements SetaPDF_Core_Encoding_EncodingInterface
{
    static public $table = array(
        "\x20\x22" => array("\x95", "\x7f", "\x81", "\x8d", "\x8f", "\x90", "\x9d"), // bullet
        "\x00\x20" => array("\x20", "\xa0"), // space
        "\x00\x00" => "\x00", // NULL
        "\x00\x0a" => "\x0a", // controlLF
        "\x00\x0b" => "\x0b", // controlVT
        "\x00\x0c" => "\x0c", // controlFF
        "\x00\x0d" => "\x0d", // controlCR
