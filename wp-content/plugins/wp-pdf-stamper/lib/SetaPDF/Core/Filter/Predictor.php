 ...
 * @version    $Id: Predictor.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
                    ...
                    if (strlen($currRowString) != $bytesPerRow) {
                        ...
                        if (strlen($currRowString) != 0) {
                            throw new SetaPDF_Core_Filter_Exception(
                                'Could not read complete row while decoding data',
                                SetaPDF_Core_Filter_Exception::DECOMPRESS_ROW_ERROR
                            );
                        }
                    }
