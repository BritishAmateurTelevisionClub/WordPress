 ...
 * @version    $Id: Image.php 816 2016-02-12 08:50:35Z jan.slabon $
 */
...
abstract class SetaPDF_Core_Image
{
    ...
    static public function getType(SetaPDF_Core_Reader_ReaderInterface $reader)
    {
        ...
        switch (1) {
            ...
            case $bytes[0] == 'M' && $bytes[1] == 'M' && $bytes[2] == "\x00" && $bytes[3] == "\x2A":
            case $bytes[0] == 'I' && $bytes[1] == 'I' && $bytes[2] == "\x2A" && $bytes[3] == "\x00":
                $type = self::TYPE_TIFF;
                break;
        }
